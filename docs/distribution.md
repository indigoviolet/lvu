...
Current release: **v0.1.14**, published from `5093e24` with Linux x86_64/arm64
...
- **v0.1.14 source and installed runtime.** Exact acceptance passed the full Rust
  workspace, Clippy, 118 bridge tests, 86 PTY suites and ten shared-capture and
  ...
  the Docker service/container PTY outside the checkout; pinned mise (including
