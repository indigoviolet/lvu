# Implementation work ledger, archive

Entries moved verbatim from `docs/work-ledger.md` on 2026-09-08: everything
before the 2026-09-07 field-correlation entry, from the empty-repository
baseline through preview 043. Nothing here is current; it is evidence. The
current ledger is [`work-ledger.md`](work-ledger.md).
