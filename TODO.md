...
| **Working** | Responsive dialogs: the exhaustive static audit at `9f295f0` is complete and independently sanity-checked. The reviewed View segmented-header baseline is integrated; the next dependency is one centralized responsive geometry core, followed by disjoint component migrations and fresh Terra review. No broad component migration starts before that core lands. |
