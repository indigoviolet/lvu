...
| **Working** | (W24) Use escaped ASCII-insensitive regex for ASCII literal/data rows, retaining exact lowercase semantics for Unicode rows. Eight-repeat A/B: 6.526M versus 4.863M records per CPU-second; guard 5.6M. Candidate `7894576` passes query tests, scan throughput, clippy and builds; matrix pending after disk recovery. |
