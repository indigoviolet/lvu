...
| **Working** | Convert dialogs to owned components (docs/component-model.md). Done: Storage, Time, Help, Settings, Fields, View, Recipes, Search/Advanced/Grouping (`Action` 194→130, `Focus` 22→13, `ui.rs` 8.2k→5.6k lines). In flight: Ask/Investigation (W14), Raw context (W15), Source (W19). Then Bookmarks, Enrichment. |
