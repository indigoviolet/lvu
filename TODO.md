...
| **Working** | Convert dialogs to owned components (docs/component-model.md). Done: Storage, Time, Help, Settings, Fields, View, Recipes, Search/Advanced/Grouping, Source (`Action` 194→114, `Focus` 22→12, `app.rs` 13.9k→10.3k, `ui.rs` 8.2k→5.0k lines). In flight: Ask/Investigation (W14), Raw context then Bookmarks (W15), Enrichment (W19). |
