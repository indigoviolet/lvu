...
| **Working** | Discoverability: every operation reachable from a visible control or the palette with its shortcut beside it, Alt mnemonics shown on their buttons, routine Enter/Tab/Esc reminders removed; audit of every dialog and the base screen. (W21, Fable) |
