...
pub const REQUIRED_COMMANDS: &[CommandId] = &[
    ...
    CommandId::CorrelationAccept,
    CommandId::CorrelationCancel,
...
fn catalog(context: &PaletteContext) -> Vec<Command> {
    ...
    let mut commands = vec![
        ...
        command(
            CommandId::Grouping,
            "Grouping",
            "Define events on an enrichment column: runs or starts",
            "Filter",
            &["multiline", "group", "run", "filter", "event"],
        ...
        command(
            ...
            "Return every expanded group to its counted line",
            "Views",
            &["fold", "repeat", "collapse all", "group"],
        ...
        command(
            CommandId::ViewSummary,
            "View summary",
            "Everything applied to this view, in evaluation order; Open goes to the owning dialog",
            "Views",
            &[
                "applied",
                "operations",
        ...
        command(
            CommandId::SeverityColumnAssistant,
            "Severity column",
            "Prepare a reviewed severity enrichment proposal",
            "Agent",
            &["severity", "level", "brain"],
            Action::Open(crate::component::Open::Ask(
                crate::components::ask::AskOpen::Task(crate::app::AskTask::SeverityColumn),
            )),
            view_reason,
        ),
        command(
