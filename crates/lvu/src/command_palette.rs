...
pub const REQUIRED_COMMANDS: &[CommandId] = &[
    ...
    CommandId::Follow,
    CommandId::Details,
    CommandId::DetailsPageUp,
    CommandId::DetailsPageDown,
...
fn catalog(context: PaletteContext) -> Vec<Command> {
    ...
    let mut commands = vec![
        ...
        command(
            CommandId::RecipeExport,
            "Export recipe TOML",
            "Export the selected immutable recipe to a new file",
            "Recipes",
            &["portable", "share", "save as"],
        ...
        command(
            ...
            "View",
            &["details page up", "previous field"],
        ...
        command(
            ...
            "View",
            &["details page down", "next field", "command result"],
            Action::ScrollDetails(6),
            view_reason,
        ),
        command(
