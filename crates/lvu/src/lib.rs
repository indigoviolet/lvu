...
pub use app::{
    ...
    InvestigationRequest, InvestigationStage, MAX_COLOR_RULES, PathCompletionRequest,
    PersistentUnion, PersistentUnionInput, PersistentViewState, QueryCompletion, QueryConstraints,
    QueryFailure, QueryPurpose, QueryRequest, RecipeConfig, RecipeDialogMode, RecipeItem,
    RecipeRequest, RecipeRequestMeta, RuleColor, SettingsContext, SettingsRequest, SettingsValues,
