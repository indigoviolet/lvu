        ...
        for attempt in (0, 1, 2):
            ...
            try:
                ...
                if attempt == 0:
                    ...
                    # All events holds a draft until it is applied, and applying
                    # it creates the view the filter belongs to.
                ...
                if attempt < 2:
                    # The bookmark belongs to the source, so the filtered view
                    # lists it too.
